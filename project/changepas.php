...
?>
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Username" name="uname" id ="uname1" onblur="validate()" value="<?php echo $result['username']; ?>" required>
              </div><br><div class="form-group">
                <input type="password" class="form-control" placeholder="Old Password" name="password" id ="pass"  value="<?php echo $result['password']; ?>" required>
              </div><br>
             
			  <div class="form-group">
                <input type="password" class="form-control" placeholder="New Password" name="password" id ="pass" onblur="validate4()" required>
              </div><br>
			  <div class="form-group">
