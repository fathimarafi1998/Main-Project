    ...
    <section class="ftco-section contact-section bg-light">
     ...
     <div class="container">
        ...
        <div class="row block-9">
		  ...
		  <div>
          <form method="POST" name="regform" action="addprofile1.php" class="bg-white p-5 contact-form">
			<center><h2 class="title">EDIT PROFILE</h2></center><br>
...
?>
			  ...
			  <div class="form-group">
                <input type="tel" class="form-control" placeholder="Phone" name="phone" id ="phno" onblur="validate2()" value="<?php echo $result['phone_no']; ?>" required>
              </div><br>
			  <div class="form-group">
            ...
            <p id="loaderIcon" style="display:none;">Loading..</p><br>
                ...
                <input type="button" value="CLOSE" class="btn btn-primary py-3 px-5" > 
